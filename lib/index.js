...
var access = exports.access = function access(path, mode) {
  return new Promise(function (success, failure) {
    ...
    _fs2.default.access(path, mode || c, mode ? c : undefined);
  });
};
...
var accessSync = exports.accessSync = function accessSync(path, mode) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.accessSync(path, mode));
    } catch (e) {
      failure(e);
    }
  });
...
var appendFile = exports.appendFile = function appendFile(file, data, options) {
  return new Promise(function (success, failure) {
    ...
    _fs2.default.appendFile(file, data, options || c, options ? c : undefined);
  });
};
...
var appendFileSync = exports.appendFileSync = function appendFileSync(file, data, options) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.appendFileSync(file, data, options));
    } catch (e) {
      failure(e);
    }
  });
...
var chmodSync = exports.chmodSync = function chmodSync(path, mode) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.chmodSync(path, mode));
    } catch (e) {
      failure(e);
    }
  });
...
var chownSync = exports.chownSync = function chownSync(path, uid, gid) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.chownSync(path, uid, gid));
    } catch (e) {
      failure(e);
    }
  });
...
var closeSync = exports.closeSync = function closeSync(fd) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.closeSync(fd));
    } catch (e) {
      failure(e);
    }
  });
...
var exists = exports.exists = function exists(path) {
  return new Promise(function (success) {
    _fs2.default.exists(path, success);
  });
};
...
var fchmodSync = exports.fchmodSync = function fchmodSync(fd, mode) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.fchmodSync(fd, mode));
    } catch (e) {
      failure(e);
    }
  });
...
var fchownSync = exports.fchownSync = function fchownSync(fd, uid, gid) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.fchownSync(fd, uid, gid));
    } catch (e) {
      failure(e);
    }
  });
...
var fdatasyncSync = exports.fdatasyncSync = function fdatasyncSync(fd) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.fdatasyncSync(fd));
    } catch (e) {
      failure(e);
    }
  });
...
var fstatSync = exports.fstatSync = function fstatSync(fd) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.fstatSync(fd));
    } catch (e) {
      failure(e);
    }
  });
...
var fsyncSync = exports.fsyncSync = function fsyncSync(fd) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.fsyncSync(fd));
    } catch (e) {
      failure(e);
    }
  });
...
var ftruncateSync = exports.ftruncateSync = function ftruncateSync(fd, len) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.ftruncateSync(fd, len));
    } catch (e) {
      failure(e);
    }
  });
...
var lchmodSync = exports.lchmodSync = function lchmodSync(path, mode) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.lchmodSync(path, mode));
    } catch (e) {
      failure(e);
    }
  });
...
var lchownSync = exports.lchownSync = function lchownSync(path, uid, gid) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.lchownSync(path, uid, gid));
    } catch (e) {
      failure(e);
    }
  });
...
var linkSync = exports.linkSync = function linkSync(srcpath, dstpath) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.linkSync(srcpath, dstpath));
    } catch (e) {
      failure(e);
    }
  });
...
var mkdir = exports.mkdir = function mkdir(path, mode) {
  return new Promise(function (success, failure) {
    ...
    _fs2.default.mkdir(path, mode || c, mode ? c : undefined);
  });
};
...
var mkdirSync = exports.mkdirSync = function mkdirSync(path, mode) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.mkdirSync(path, mode));
    } catch (e) {
      failure(e);
    }
  });
...
var mkdtempSync = exports.mkdtempSync = function mkdtempSync(prefix) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.mkdtempSync(prefix));
    } catch (e) {
      failure(e);
    }
  });
...
var open = exports.open = function open(path, flags, mode) {
  return new Promise(function (success, failure) {
    var c = function c(e, fd) {
      if (!e) return success(fd);
      failure(e);
    };
    _fs2.default.open(path, flags, mode || c, mode ? c : undefined);
  });
};
...
var openSync = exports.openSync = function openSync(path, flags, mode) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.openSync(path, flags, mode));
    } catch (e) {
      failure(e);
    }
  });
...
var read = exports.read = function read(fd, buffer, offset, length, position) {
  return new Promise(function (success, failure) {
    _fs2.default.read(fd, buffer, offset, length, position, function (e, bytesRead, buffer) {
      if (!e) return success({ bytesRead: bytesRead, buffer: buffer });
      failure(e);
    });
  });
};
...
var readdir = exports.readdir = function readdir(path, options) {
  return new Promise(function (success, failure) {
    ...
    _fs2.default.read(path, options || c, options ? c : undefined);
  });
};
...
var readFile = exports.readFile = function readFile(file, options) {
  return new Promise(function (success, failure) {
    var c = function c(e, data) {
      if (!e) return success(data);
      failure(e);
    };
    _fs2.default.readFile(file, options || c, options ? c : undefined);
  });
};
...
var readFileSync = exports.readFileSync = function readFileSync(file, options) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.readFileSync(file, options));
    } catch (e) {
      failure(e);
    }
  });
...
var readlink = exports.readlink = function readlink(path, options) {
  return new Promise(function (success, failure) {
    var c = function c(e, linkString) {
      if (!e) return success(linkString);
      failure(e);
    };
    _fs2.default.readlink(path, options || c, options ? c : undefined);
  });
};
...
var readlinkSync = exports.readlinkSync = function readlinkSync(path, options) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.readlinkSync(path, options));
    } catch (e) {
      failure(e);
    }
  });
...
var realpath = exports.realpath = function realpath(path, options) {
  return new Promise(function (success, failure) {
    var c = function c(e, resolvedPath) {
      if (!e) return success(resolvedPath);
      failure(e);
    };
    _fs2.default.realpath(path, options || c, options ? c : undefined);
  });
};
...
var realpathSync = exports.realpathSync = function realpathSync(path, options) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.realpathSync(path, options));
    } catch (e) {
      failure(e);
    }
  });
...
var renameSync = exports.renameSync = function renameSync(oldPath, newPath) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.renameSync(oldPath, newPath));
    } catch (e) {
      failure(e);
    }
  });
...
var rmdirSync = exports.rmdirSync = function rmdirSync(path) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.rmdirSync(path));
    } catch (e) {
      failure(e);
    }
  });
...
var symlink = exports.symlink = function symlink(target, path, type) {
  return new Promise(function (success, failure) {
    ...
    _fs2.default.symlink(target, path, type || c, type ? c : undefined);
  });
};
...
var truncateSync = exports.truncateSync = function truncateSync(path, len) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.truncateSync(path, len));
    } catch (e) {
      failure(e);
    }
  });
...
var unlinkSync = exports.unlinkSync = function unlinkSync(path) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.unlinkSync(path));
    } catch (e) {
      failure(e);
    }
  });
...
var watch = exports.watch = function watch(filename, options, listener) {
  return Promise.resolve(_fs2.default.watch(filename, options || listener, options ? listener : undefined));
};
...
var write = exports.write = function write(fd, data, v1, v2, v3) {
  return new Promise(function (success, failure) {
    ...
    if (data instanceof Buffer) {
      _fs2.default.write(fd, data, v1, v2, b3 ? v3 : c, b3 ? c : undefined);
    } else {
      _fs2.default.write(fd, data, b1 ? v1 : b2 ? v2 : c, b1 ? b2 ? v2 : c : b2 ? c : undefined);
    }
  });
};
...
var writeFile = exports.writeFile = function writeFile(file, data, options) {
  return new Promise(function (success, failure) {
    ...
    _fs2.default.writeFile(file, data, options || c, options ? c : undefined);
  });
};
...
var writeFileSync = exports.writeFileSync = function writeFileSync(file, data, options) {
  return new Promise(function (success, failure) {
    try {
      success(_fs2.default.writeFileSync(file, data, options));
    } catch (e) {
      failure(e);
    }
  });
...
var writeSync = exports.writeSync = function writeSync(fd, data, v1, v2, v3) {
  return new Promise(function (success, failure) {
    ...
    var b3 = isNaN(v3);
    if (data instanceof Buffer) {
      _fs2.default.writeSync(fd, data, v1, v2, b3 ? v3 : undefined);
    } else {
      _fs2.default.writeSync(fd, data, b1 ? v1 : b2 ? v2 : undefined, b1 ? b2 ? v2 : undefined : undefined);
    }
  });
};
