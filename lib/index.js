...
var copyFile = exports.copyFile = function copyFile(src, dest, flags) {
  return new Promise(function (resolve, reject) {
    _fs2.default.copyFile(src, dest, flags, function (e) {
      return !e ? resolve() : reject(e);
    });
  });
};
...
var copyFileSync = exports.copyFileSync = function copyFileSync(src, dest, flags) {
  return new Promise(function (resolve, reject) {
    try {
      resolve(_fs2.default.copyFileSync(src, dest, flags));
    } catch (e) {
      reject(e);
    }
  });
...
var readdir = exports.readdir = function readdir(path, options) {
  return new Promise(function (resolve, reject) {
    _fs2.default.readdir(path, options, function (e, files) {
      return !e ? resolve(files) : reject(e);
    });
  });
};
